...
//    Doctor doctor;
    ...
    public void initialize(Stage stage, HazelcastInstance hazelcastInstance, Stage newWindow, ObservableList<Patient> patientObservableList, TableView<Patient> tableView_PatientTable) throws IOException {
        userMap = hazelcastInstance.getMap("userMap");
        stage.setOnHidden(event -> {
            hazelcastInstance.getLifecycleService().shutdown();
        });
...
//        windowsController.openWindowResizable("mainMenu.fxml", getStage(), getInstance(), mainMenuController, "Main menu", 600, 640);
    ...
    public void checkChoiceBox(ActionEvent event) {
        System.out.println(recordMenuController.getChoiceBox_Sex().getSelectionModel().getSelectedItem());
        System.out.println(recordMenuController.getChoiceBox_BloodGroup().getSelectionModel().getSelectedItem());
        System.out.println(recordMenuController.getChoiceBox_BloodType().getSelectionModel().getSelectedItem());
        System.out.println(recordMenuController.getDatePicker_Birthday().getValue());
        System.out.println(recordMenuController.getDatePicker_Birthday().getValue().getDayOfMonth());
        System.out.println(recordMenuController.getDatePicker_Birthday().getValue().getDayOfWeek());
        System.out.println(recordMenuController.getDatePicker_Birthday().getValue().getDayOfYear());
        System.out.println(recordMenuController.getDatePicker_Birthday().getValue().getMonth());
        System.out.println(recordMenuController.getDatePicker_Birthday().getValue().getYear());
    }
    ...
    public void printAllFields() {
        ...
        System.out.println(patientMenuController.getTextField_Name().getText());
        System.out.println(patientMenuController.getTextField_Surname().getText());
        System.out.println(patientMenuController.getTextField_Telephone().getText());
        System.out.println(patientMenuController.getTextField_Address().getText());
        System.out.println(patientMenuController.getTextField_Email().getText());
        System.out.println("\n");
        System.out.println("Card:");
        System.out.println(recordMenuController.getDatePicker_Birthday().getValue().toString());
        System.out.println(recordMenuController.getChoiceBox_Sex().getSelectionModel().getSelectedItem().toString());
        System.out.println(recordMenuController.getChoiceBox_BloodGroup().getSelectionModel().getSelectedItem() + recordMenuController.getChoiceBox_BloodType().getSelectionModel().getSelectedItem());
        System.out.println(recordMenuController.getTextField_Weight().getText());
        System.out.println(recordMenuController.getTextField_Height().getText());
    }
}
