...
//        label_CurrentDate.setText(localDate.format(formatter));
        ...
        page = new Page();
        page.setDate(date);
//            page.setDate(formatter2.parse(label_CurrentDate.getText()));
...
//        label_CurrentDate.setText(formatter2.format(page.getDate()));
        label_CurrentDate.setText(String.valueOf(page.getDate()));

        textArea_Symptoms.setText(this.page.getTheme());
...
//    }
    ...
    public void savePage(ActionEvent event) throws IOException, ParseException {
        if (create) {
            page.setTheme(textArea_Symptoms.getText());
